  ...
  <Table sortable celled striped>
    ...
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faServer} size="4x" className="sixty" />
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faMountain} size="4x" className="twenty" />
          <Label basic pointing="right">
            <Statistic size="mini">
              <Statistic.Value>20%</Statistic.Value>
            </Statistic>
      ...
      <Table.Row>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faServer} size="4x" className="seventyfive" />
          <Label color="teal" pointing="right">
            <Statistic size="mini" inverted>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faKey} size="4x" className="five" />
          <Label basic pointing="right">
            <Statistic size="mini">
      ...
      <Table.Row>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faKey} size="4x" className="twenty" />
          <Label basic pointing="right">
            <Statistic size="mini">
              <Statistic.Value>20%</Statistic.Value>
            </Statistic>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faPrint} size="4x" className="five" />
          <Label basic pointing="right">
            <Statistic size="mini">
              <Statistic.Value>5%</Statistic.Value>
            </Statistic>
      ...
      <Table.Row>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faUserCog} size="4x" className="twenty" />
          <Label basic pointing="right">
            <Statistic size="mini">
              <Statistic.Value>20%</Statistic.Value>
            </Statistic>
        ...
        <Table.Cell>
          <FontAwesomeIcon icon={faCodeBranch} size="4x" className="twenty" />
          <Label basic pointing="right">
            <Statistic size="mini">
              <Statistic.Value>20%</Statistic.Value>
            </Statistic>
